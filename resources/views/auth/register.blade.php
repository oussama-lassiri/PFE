...
@section('style')
    ...
    <style>
      ...
      .sbt {
          ...
          border: none;
          background: #5be6c3;
          background: -moz-linear-gradient(-45deg, #a7dbee 15%, #007180 100%);
          background: -webkit-linear-gradient(-45deg, #a7dbee 15%, #007180 100%);
          background: linear-gradient(135deg, #a7dbee 15%, #007180 100%);
...
<div class="container">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div  class="info-item">
            ...
            <input type="email" class=" @error('email') is-invalid @enderror" name="email" id="email" placeholder="Email" value="{{ old('email') }}" required autocomplete="email"/>
            @error('email')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
