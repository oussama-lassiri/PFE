        ...
        <div class="col-8">
            ...
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                    ...
                    <img src="\img\terrain_immo.jpg" style="width: 600px;" >
            ...
            <div class="col">
                ...
                <hr style="height: 2px;width-left:50%;background-color: darkturquoise;">
                <p class="card-text">Titré / Lotissement  </p>
                <br>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="video-popup" href="yout" title="Virtual Tour">
                            <img src="\img\terrain-video.jpg" class="img-responsive wp-post-image" alt="visite virtuelle" width="100%">
                        </a>
                    </div>
                </div>
                <br>
