        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                ...
                <div class="p-2 annonce bd-highlight animate__animated animate__swing" >   <!-- class="d-grid gap-2  d-md-flex justify-content-md-end " -->
                    <a href="@if(isset(Auth::user()->etat)) @if(Auth::user()->etat == "inactive" || Auth::user()->etat == "desactive" || Auth::user()->etat == "bloque"){{route('resultat')}}?res=fail @else {{route('first_page.index')}} @endif @endif">
